<template>
  <section>
    <div class="container py-5">
      ...
      <details v-for="(item, index) in $options.items" :key="index" open>
        <summary class="pb-3">
...
const items = [
  {
    ...
    answer:
      "Hit that button in the upper right corner and Sign Up to become involved in the community. Once you start to build out your profile, we make it easy for you to fill out the campaign application form allowing you to get your campaign off the ground."
  },
  {
    question:
  ...
  {
    question: "How much fundraising can be raised for each campaign?",
    answer:
      "The range at which any company can raise on our website is anywhere from $10k to $1.07M."
  }
];
