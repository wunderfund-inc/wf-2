    ...
    b-container
      div(v-if="!isAccredited")
        ...
        p Based on the
          ...
          | , if you want to invest more than $2,200 annually on our platform, you're required to let us know that you qualify. Click the button below, and we'll verify you via email.
