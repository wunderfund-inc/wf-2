            ...
            <div v-if="content.campaign_video.embed_url" class="pb-3">
              ...
              <div class="pt-3">
                ...
                <small>
                  ...
                  <a
                    :href="`https://www.linkedin.com/shareArticle/?mini=true&url=https://wunderfund.co%2F${$route.params.companyId}&title=I%20invested%20in%20${content.company_name_short}!`"
                    target="_blank"
                    class="pl-3 pr-2 text-muted"
                  >
                    <font-awesome-icon
                  ...
                  <a
                    :href="`https://twitter.com/intent/tweet?url=https://wunderfund.co%2F${$route.params.companyId}&text=I%20invested%20in%20${content.company_name_short}!`"
                    target="_blank"
                    class="pl-3 pr-2 text-muted"
                  >
                    <font-awesome-icon
          ...
          <div>
            ...
            <div v-if="!content.campaign_video.embed_url" class="py-3">
              ...
              <small>
                ...
                <a
                  :href="`https://www.linkedin.com/shareArticle/?mini=true&url=https://wunderfund.co%2F${$route.params.companyId}&ti tle=I%20invested%20in%20${content.company_name_short}!`"
                  target="_blank"
                  class="pl-3 pr-2 text-muted"
                >
                  <font-awesome-icon
